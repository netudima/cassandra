...
public class UTF8Serializer extends AbstractTextSerializer
{
    ...
    public <V> void validateOld(V value, ValueAccessor<V> accessor) throws MarshalException
    {
        if (!UTF8Validator.validateOld(value, accessor))
            throw new MarshalException("String didn't validate.");
    }
    ...
    static class UTF8Validator
    {
        ...
        static <V> boolean validateOld(V value, ValueAccessor<V> accessor)
        {
            if (value == null)
                return false;
        ...
        static <V> boolean validate(V value, ValueAccessor<V> accessor)
        {
            ...
            // perf optimization:
            // 1) to avoid bymorhic/megamorphic calls via ValueAccessor
            // 2) to process typical ASCII String scenario faster
